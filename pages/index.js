    ...
    <>
      ...
      <div>
        <p className="font-mono text-2xl">
          I am a bot that can write code for you. I can write HTML, CSS, and JavaScript.
        </p>
        <p className="font-mono text-2xl">
          I am still learning, so I might make mistakes. If you see something that looks wrong, please let my creators know.
        </p>
        <Image
